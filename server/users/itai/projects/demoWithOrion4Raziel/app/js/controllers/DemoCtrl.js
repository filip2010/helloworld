...
yourApp.controller('DemoCtrl', ['$rootScope', '$scope',
  function($rootScope, $scope) {
    $scope.yourString = "hello world";
  }]); 

yourApp.directive('demo', function($window) {
 
    function link(scope, element, attrs) {
       initTipCard($window.jQuery);
    }
